...
`.trim(),
  ...
  // handle the event when the call is ended
  // vapi.on("call-start", () => {
  //   console.log("Call has started.");
  //   toast('Call Connceted.....')
  // });
  ...
  //   // when ever the call is ended the  we call the generatethefeedback function
  //   GenerateFeedback(); 
  // });
  ...
  useEffect(()=>{
      const handleMessage = (message) =>{
        ...
        if(message?.conversation){
          ...
          console.log('conversation string',conversation);
  ...
  try {
    ...
    try {
      ...
      parsedFeedback = FINAL_CONTENT; // fallback to raw string
    }
    ...
    // after success redirect to completed page
  ...
  return (
    <div className='p-20 lg:px-48 xl:px-56'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-7 mt-5'>
            <div className='bg-white h-[400px]  rounded-lg border
              flex flex-col gap-3 justify-center items-center'>
                <div className='relative'>
                    {!activeUser && <span className='absolute inset-0 rounded-full bg-blue-500 opacity-75 animate-ping' /> }
                    <Image src={'/AI.jpg'} alt='interview' 
